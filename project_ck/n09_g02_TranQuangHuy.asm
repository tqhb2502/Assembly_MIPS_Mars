...
game_loop:
	nop
wait_for_key:					# wait until there is a key input
	lw $t1, 0($k1)				# $t1 = key ready value
	beqz $t1, wait_for_key			# if $t1 == 0, there is no key input, continue waiting
